...
urlpatterns = [
    ...
    path('product/', views.ProductAdminList.as_view(), name='product-admin'),
    path('product-detail/<int:pk>/', views.ProductAdminDetail.as_view(),
    ...
    path('order-detail/<int:pk>/', views.AdminOrderDetail.as_view(),
